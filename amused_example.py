...
try:
    ...
    print(f"Error importing amused-py SDK: {e}")
    print("Please install amused-py: pip install git+https://github.com/thecodenomad/amused-py.git")
    sys.exit(1)

# Import numpy for signal processing
try:
    import numpy as np
except ImportError:
